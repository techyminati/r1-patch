...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LJ0/c;->a:Landroidx/collection/SimpleArrayMap;

    new-instance v0, Landroidx/collection/SimpleArrayMap;

    invoke-direct {v0}, Landroidx/collection/SimpleArrayMap;-><init>()V

    iput-object v0, p0, LJ0/c;->b:Landroidx/collection/SimpleArrayMap;

    return-void
.end method

.method public static a(Landroid/content/Context;I)LJ0/c;
    .locals 3
    ...
    invoke-static {p0}, LJ0/c;->b(Ljava/util/ArrayList;)LJ0/c;
    ...
    invoke-static {v1}, LJ0/c;->b(Ljava/util/ArrayList;)LJ0/c;
...
.method public static b(Ljava/util/ArrayList;)LJ0/c;
    .locals 13
    ...
    iget-object v7, v0, LJ0/c;->b:Landroidx/collection/SimpleArrayMap;
    ...
    sget-object v11, LJ0/a;->d:LL/c;

    goto :goto_2

    :cond_2
    :goto_1
    sget-object v11, LJ0/a;->b:LL/b;

    :cond_3
    :goto_2
    invoke-direct {v6}, Ljava/lang/Object;-><init>()V

    iput v2, v6, LJ0/d;->d:I

    const/4 v12, 0x1

    iput v12, v6, LJ0/d;->e:I

    iput-wide v7, v6, LJ0/d;->a:J

    iput-wide v9, v6, LJ0/d;->b:J

    iput-object v11, v6, LJ0/d;->c:Landroid/animation/TimeInterpolator;

    invoke-virtual {v4}, Landroid/animation/ValueAnimator;->getRepeatCount()I

    move-result v7

    iput v7, v6, LJ0/d;->d:I

    invoke-virtual {v4}, Landroid/animation/ValueAnimator;->getRepeatMode()I

    move-result v4

    iput v4, v6, LJ0/d;->e:I

    iget-object v4, v0, LJ0/c;->a:Landroidx/collection/SimpleArrayMap;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object p0, p0, LJ0/c;->a:Landroidx/collection/SimpleArrayMap;

    iget-object p1, p1, LJ0/c;->a:Landroidx/collection/SimpleArrayMap;
