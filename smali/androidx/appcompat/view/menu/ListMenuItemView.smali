...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v1, La/a;->s:[I

    const v2, 0x7f0302c0

    const/4 v3, 0x0

    invoke-static {v0, p2, v1, v2, v3}, Lf/n1;->e(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lf/n1;

    move-result-object p2

    const/4 v0, 0x5

    invoke-virtual {p2, v0}, Lf/n1;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p2, Lf/n1;->b:Landroid/content/res/TypedArray;
...
.method public final b(Le/r;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Le/r;
    ...
    iget-object v0, p1, Le/r;->n:Le/p;

    invoke-virtual {v0}, Le/p;->o()Z
    ...
    invoke-virtual {v0}, Le/p;->n()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-char v0, p1, Le/r;->j:C

    goto :goto_1

    :cond_1
    iget-char v0, p1, Le/r;->h:C
    ...
    :goto_2
    iget-object v4, p1, Le/r;->n:Le/p;

    invoke-virtual {v4}, Le/p;->n()Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Le/r;

    iget-object v4, v0, Le/r;->n:Le/p;

    invoke-virtual {v4}, Le/p;->o()Z
    ...
    iget-char v0, v0, Le/r;->j:C

    goto :goto_3

    :cond_3
    iget-char v0, v0, Le/r;->h:C
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Le/r;

    iget-object v5, v4, Le/r;->n:Le/p;

    invoke-virtual {v5}, Le/p;->n()Z

    move-result v5

    if-eqz v5, :cond_5

    iget-char v5, v4, Le/r;->j:C

    goto :goto_5

    :cond_5
    iget-char v5, v4, Le/r;->h:C
    ...
    :cond_6
    iget-object v6, v4, Le/r;->n:Le/p;

    iget-object v7, v6, Le/p;->a:Landroid/content/Context;
    ...
    iget-object v9, v6, Le/p;->a:Landroid/content/Context;
    ...
    invoke-static {v8, v4, v9, v6}, Le/r;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v4, v3, v6}, Le/r;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v4, v6, v3}, Le/r;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v4, v1, v3}, Le/r;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    iget-object p1, p1, Le/r;->q:Ljava/lang/CharSequence;
...
.method public getItemData()Le/r;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Le/r;
