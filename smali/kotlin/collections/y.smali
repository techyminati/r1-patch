...
.method public static emptyMap()Ljava/util/Map;
    ...
    sget-object v0, Lkotlin/collections/r;->a:Lkotlin/collections/r;
...
.method public static final varargs linkedMapOf([Lkotlin/Pair;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/y;->toMap([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final minus(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    .line 2
    invoke-static {p0}, Lkotlin/collections/y;->toMutableMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/n;->removeAll(Ljava/util/Collection;Ljava/lang/Iterable;)Z

    invoke-static {p0}, Lkotlin/collections/y;->optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lkotlin/collections/x;->toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final plus(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lkotlin/collections/y;->toMap(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/y;->putAll(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final plus(Ljava/util/Map;Lkotlin/sequences/Sequence;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/y;->putAll(Ljava/util/Map;Lkotlin/sequences/Sequence;)V

    invoke-static {v0}, Lkotlin/collections/y;->optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final plus(Ljava/util/Map;[Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lkotlin/collections/y;->toMap([Lkotlin/Pair;)Ljava/util/Map;
...
.method public static toMap(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/y;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    :goto_1
    invoke-static {p0}, Lkotlin/collections/x;->mapOf(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/y;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 7
    invoke-static {p1, p0}, Lkotlin/collections/y;->putAll(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final toMap(Lkotlin/sequences/Sequence;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/y;->toMap(Lkotlin/sequences/Sequence;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final toMap(Lkotlin/sequences/Sequence;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 14
    invoke-static {p1, p0}, Lkotlin/collections/y;->putAll(Ljava/util/Map;Lkotlin/sequences/Sequence;)V
...
.method public static final toMap([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 12
    invoke-static {p1, p0}, Lkotlin/collections/y;->putAll(Ljava/util/Map;[Lkotlin/Pair;)V
