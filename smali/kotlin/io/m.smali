...
.method public static final c(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lkotlin/io/g;->toComponents(Ljava/io/File;)Lkotlin/io/FilePathComponents;
    ...
    invoke-static {v0}, Lkotlin/io/m;->b(Ljava/util/List;)Ljava/util/ArrayList;

    move-result-object v0

    invoke-direct {v1, v2, v0}, Lkotlin/io/FilePathComponents;-><init>(Ljava/io/File;Ljava/util/List;)V

    invoke-static/range {p1 .. p1}, Lkotlin/io/g;->toComponents(Ljava/io/File;)Lkotlin/io/FilePathComponents;
    ...
    invoke-static {v9, v0}, Lio/sentry/android/core/internal/util/c;->g(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public static final copyRecursively(Ljava/io/File;Ljava/io/File;ZLkotlin/jvm/functions/Function2;)Z
    ...
    invoke-direct/range {v3 .. v8}, Lkotlin/io/NoSuchFileException;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;ILkotlin/jvm/internal/k;)V
    ...
    :cond_1
    :try_start_0
    invoke-static {p0}, Lkotlin/io/j;->walkTopDown(Ljava/io/File;)Lkotlin/io/FileTreeWalk;

    move-result-object v0

    new-instance v3, Lkotlin/io/l;

    invoke-direct {v3, p3, v2}, Lkotlin/io/l;-><init>(Lkotlin/jvm/functions/Function2;I)V
    ...
    invoke-direct/range {v4 .. v9}, Lkotlin/io/NoSuchFileException;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;ILkotlin/jvm/internal/k;)V
    ...
    :cond_3
    invoke-static {v3, p0}, Lkotlin/io/m;->toRelativeString(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lkotlin/io/m;->deleteRecursively(Ljava/io/File;)Z
    ...
    invoke-static/range {v4 .. v9}, Lkotlin/io/m;->copyTo$default(Ljava/io/File;Ljava/io/File;ZIILjava/lang/Object;)Ljava/io/File;
    ...
    sget-object v4, Lkotlin/io/OnErrorAction;->TERMINATE:Lkotlin/io/OnErrorAction;
    :try_end_0
    .catch Lkotlin/io/o; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static synthetic copyRecursively$default(Ljava/io/File;Ljava/io/File;ZLkotlin/jvm/functions/Function2;ILjava/lang/Object;)Z
    ...
    sget-object p3, Lkotlin/io/k;->a:Lkotlin/io/k;

    :cond_1
    invoke-static {p0, p1, p2, p3}, Lkotlin/io/m;->copyRecursively(Ljava/io/File;Ljava/io/File;ZLkotlin/jvm/functions/Function2;)Z
...
.method public static final copyTo(Ljava/io/File;Ljava/io/File;ZI)Ljava/io/File;
    ...
    invoke-direct/range {v0 .. v5}, Lkotlin/io/NoSuchFileException;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;ILkotlin/jvm/internal/k;)V
...
.method public static synthetic copyTo$default(Ljava/io/File;Ljava/io/File;ZIILjava/lang/Object;)Ljava/io/File;
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lkotlin/io/m;->copyTo(Ljava/io/File;Ljava/io/File;ZI)Ljava/io/File;
...
.method public static synthetic createTempDir$default(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;ILjava/lang/Object;)Ljava/io/File;
    ...
    :cond_2
    invoke-static {p0, p1, p2}, Lkotlin/io/m;->createTempDir(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
...
.method public static synthetic createTempFile$default(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;ILjava/lang/Object;)Ljava/io/File;
    ...
    :cond_2
    invoke-static {p0, p1, p2}, Lkotlin/io/m;->createTempFile(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
...
.method public static deleteRecursively(Ljava/io/File;)Z
    ...
    invoke-static {p0}, Lkotlin/io/j;->walkBottomUp(Ljava/io/File;)Lkotlin/io/FileTreeWalk;
...
.method public static final endsWith(Ljava/io/File;Ljava/io/File;)Z
    ...
    .line 1
    invoke-static {p0}, Lkotlin/io/g;->toComponents(Ljava/io/File;)Lkotlin/io/FilePathComponents;

    move-result-object v0

    .line 2
    invoke-static {p1}, Lkotlin/io/g;->toComponents(Ljava/io/File;)Lkotlin/io/FilePathComponents;
...
.method public static final endsWith(Ljava/io/File;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0}, Lkotlin/io/m;->endsWith(Ljava/io/File;Ljava/io/File;)Z
...
.method public static final getInvariantSeparatorsPath(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static/range {v1 .. v6}, Lkotlin/text/t;->replace$default(Ljava/lang/String;CCZILjava/lang/Object;)Ljava/lang/String;
...
.method public static final normalize(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {p0}, Lkotlin/io/m;->b(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-static {v2, p0}, Lio/sentry/android/core/internal/util/c;->g(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lkotlin/io/m;->resolve(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
...
.method public static final relativeTo(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {p0, p1}, Lkotlin/io/m;->toRelativeString(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
...
.method public static final relativeToOrNull(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {p0, p1}, Lkotlin/io/m;->c(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
...
.method public static final resolve(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    .line 1
    invoke-static {p1}, Lkotlin/io/g;->isRooted(Ljava/io/File;)Z
...
.method public static final resolve(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p0, v0}, Lkotlin/io/m;->resolve(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
...
.method public static final resolveSibling(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {p0, p1}, Lkotlin/io/m;->resolve(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
...
.method public static final resolveSibling(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p0, v0}, Lkotlin/io/m;->resolveSibling(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
...
.method public static final startsWith(Ljava/io/File;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0}, Lkotlin/io/m;->startsWith(Ljava/io/File;Ljava/io/File;)Z
