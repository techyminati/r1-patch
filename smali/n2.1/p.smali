...
.method public static synthetic createTempDirectory$default(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;ILjava/lang/Object;)Ljava/nio/file/Path;
    ...
    .line 5
    :cond_0
    invoke-static {p0, p1, p2}, Ln2/p;->createTempDirectory(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
...
.method public static synthetic createTempFile$default(Ljava/nio/file/Path;Ljava/lang/String;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;ILjava/lang/Object;)Ljava/nio/file/Path;
    ...
    .line 5
    :cond_1
    invoke-static {p0, p1, p2, p3}, Ln2/p;->createTempFile(Ljava/nio/file/Path;Ljava/lang/String;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
...
.method public static synthetic listDirectoryEntries$default(Ljava/nio/file/Path;Ljava/lang/String;ILjava/lang/Object;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {p0, p1}, Ln2/p;->listDirectoryEntries(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/util/List;
...
.method public static final relativeTo(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    :try_start_0
    invoke-static {p0, p1}, Ln2/e;->a(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method public static final relativeToOrSelf(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1}, Ln2/p;->relativeToOrNull(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method public static final visitFileTree(Ljava/nio/file/Path;IZLkotlin/jvm/functions/Function1;)V
    ...
    .line 2
    invoke-static {p3}, Ln2/p;->fileVisitor(Lkotlin/jvm/functions/Function1;)Ljava/nio/file/FileVisitor;

    move-result-object p3

    invoke-static {p0, p3, p1, p2}, Ln2/p;->visitFileTree(Ljava/nio/file/Path;Ljava/nio/file/FileVisitor;IZ)V
...
.method public static final visitFileTree(Ljava/nio/file/Path;Ljava/nio/file/FileVisitor;IZ)V
    ...
    invoke-static {p3}, Lkotlin/collections/F;->setOf(Ljava/lang/Object;)Ljava/util/Set;
...
.method public static synthetic visitFileTree$default(Ljava/nio/file/Path;IZLkotlin/jvm/functions/Function1;ILjava/lang/Object;)V
    ...
    .line 2
    :cond_1
    invoke-static {p0, p1, p2, p3}, Ln2/p;->visitFileTree(Ljava/nio/file/Path;IZLkotlin/jvm/functions/Function1;)V
...
.method public static synthetic visitFileTree$default(Ljava/nio/file/Path;Ljava/nio/file/FileVisitor;IZILjava/lang/Object;)V
    ...
    .line 4
    :cond_1
    invoke-static {p0, p1, p2, p3}, Ln2/p;->visitFileTree(Ljava/nio/file/Path;Ljava/nio/file/FileVisitor;IZ)V
